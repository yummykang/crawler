...
public class MongodbUtils {
    ...
    public static void update(String url) {
        ...
        DB.getCollection(DB_NAME_RUNTIME).findOneAndUpdate(searchQuery, newDocument);
    }
    ...
    public static List<Document> findAll() {
        ...
        return result.find(Filters.eq("status", 0)).into(new ArrayList<>());
    }
